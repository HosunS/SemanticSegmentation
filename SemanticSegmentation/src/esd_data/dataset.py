...
class ESDDataset(Dataset):
    ...
    def __init__(
        ...
        for tiles in (processed_dir / 'subtiles').iterdir():
            # iterate over the subtiles within the tile
            for subtile in tiles.iterdir():
    ...
    def __len__(self) -> int:
        ...
        """
        # --- start here ---
        # return the length of the subtile_dirs
    ...
    def __getitem__(self, idx):
        ...
        subtile = Subtile.load_subtile_by_dir(self.subtile_dirs[idx], satellite_type_list=self.satellite_type_list)
        ...
        y = ground_truth.squeeze(axis=(0, 1))
        ...
        if self.transform is not None:
            ...
            X = transformed_sample["X"]
            y = transformed_sample["y"]
