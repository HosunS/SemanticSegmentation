...
class FCNResnetTransfer(nn.Module):
    def __init__(self, in_channels, out_channels, scale_factor=50, **kwargs):
        ...
        self.model.classifier[-1] = nn.Conv2d(512, out_channels, kernel_size = (1, 1), stride = (1,1))

        # create a final pooling layer that's a maxpool2d, of kernel size scale_factor
        self.pooling_layer = nn.AvgPool2d(kernel_size = scale_factor)
    ...
    def forward(self, x):
        ...
        pooled_output = self.pooling_layer(model_output)
